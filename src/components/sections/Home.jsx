...
export const Home = () => {
  ...
  const groups = [
    ...
    { text: "Sempre que fico te encarando... é pq eu to pensando no que falar... pensando em como chamar sua atenção"},
    { text: "Pensando num assunto que você se interessaria, pensando em fazer algo que a gente pudesse brincar sobre"},
    { text: "Mas no final eu ficava la te olhando, olhando pra pessoa mais bela e incrivel que eu já vi na minha vida"},
    { text: "Relembrando nosso passado, nossos momentos juntos, e puramente hipnotizado por você"},
    { text: "Sempre que eu te vejo parece que o tempo desacelera, parece um filme longo e maravilhoso, que eu jamais iria querer sair do cinema"},
    { text: "E por mais que o tempo estivesse devagar, tudo que eu queria era conversar com você, ter mais um momento com você, fiquei pensando no que dizer que acabou que não disse nada"},
    ...
    { text: "Então você me chamou pra unjadimo... você não tem noção de como aquilo me deixou feliz"},
    ...
    { text: "Amo seu sorriso lindo, Amo seus olhos escuros como o espaço, Amo seu cabelo cheiroso e exuberantemente bonito"},
    { text: "Amo tudo em você"},
    ...
    { text: "Eu sei que provavelmente nada disso vai ajudar em nada, mas eu penso em você até hoje"},
    { text: "Eu sei que você seguiu, que está namorando alguem, que está feliz e bem, e eu fico muito feliz com isso"},
    { text: "Por que mais do que querer ter você comigo, eu quero que você seja feliz, mesmo que não seja comigo"},
    { text: "Desde que ele te trate bem, te valorize como você merece, e arranque esse sorriso maravilhoso todos os dias"},
    { text: "Esse sorriso maravilhoso e explendido pelo qual sou apaixonado até hoje"},
    { text: "Então tudo bem"},
    { text: "Vou fazer a minha parte, e me distanciar de você. Não vou mais te procurar, não vou mais tentar falar com você, não vou mais tentar ter qualquer tipo de contato com você"},
    { text: "Não quero atrapalhar sua felicidade, não quero atrapalhar você. Vou somente me afastar e amar você de longe, me convencendo de que você está melhor sem mim"},
    { text: "Sua felicidade é a coisa mais importante pra mim, por que você é a pessoa mais importante pra mim, e nada importa mais pra mim do que você"},
    { text: "Doi até hoje... mas vou continuar torcendo por você, orando por você, e amando você"},
    { text: "Amando você com tudo que eu tenho e posso oferecer"},
    { text: "Só que ainda sim..."},
    { text: "Ainda sinto sua falta..."},
    { text: "Uma parte de mim, que é incapaz de te esquecer, ainda sente sua falta"},
    { text: "Sinto saudade dos seus abraços, do seu cheiro, dos seus beijos, do seu sorriso explandecente"},
    { text: "Sinto saudade das festas da sua familia, de te acompanhar na igreja, de ir comer lanche com você, de tentar ver os 1000 reels que você mandava por dia"},
    { text: "Saudade das nossas brincaderias, das nossas conversas intermináveis, dos nossos encontros simples e maravilhosos"},
    { text: "Saudade de você"},
    ...
    { text: "Sinto falta de algo que não existe mais... mas eu amo você, por que eu amo quem você é"},
    { text: "Amo o jeito que você se empolga contando alguma coisa que gosta, o jeito como fica quando ta indignada com algo, o jeito que fica feliz comendo suas comidas favoritas"},
    { text: "Amo o quanto você ama seus pais, o quanto é devota, o quanto se importa com as pessoas que gosta e ajuda até mesmo as pessoas de quem não gosta"},
    { text: "Amo você ser tão responsável com suas coisas, o quanto se esforça tanto todos os dias mesmo quando ta exausta e doente, mesmo quando ta com dor e cheia de coisa pra fazer você não para"},
    { text: "Amo como sabe o que tem que fazer, não para nem por um segundo enquanto não terminar, e ainda ajuda as outras pessoas com o que pode sem se anular"},
    { text: "Amo como você é chata com comida, amo como você se irria facilmente, amo como quando você fala sobre algo que te deixou indignada, fica bufando e fica cansada só de contar sobre kkkk"},
    { text: "Amo o amor que você sente pelos animais, amo como você gosta de colecionar coisas fofas, amo você gostar tanto das suas pelúcias"},
    { text: "Amo como você ta sempre tentando algo novo, sempre tentando aprender coisas novas, sempre querendo usar algo diferente, fazer algo inusitado"},
    { text: "Eu falo de novo, eu amo completamente tudo em você, tudo que você é, tudo que você faz, tudo que você se esforça pra ser, tudo em você, e eu não gostaria que você você diferente em nada"},
    ...
    { text: "Quero você de volta"},
    { text: "Quero você de volta pra nós"},
    { text: "De volta pra gente"},
    { text: "De volta pra mim"},
    { text: "Eu te amo",
      extras: (
        <img
    ...
    { text: "Mas espero ter conseguido passar o que eu queria"},
    { text: "Não precisa responder isso se não quiser, pode só ignorar e fingir que não viu isso tudo"},
    { text: "Mas..."},
    { text: "Pensa nisso... sei que você pensa em tudo kkkk, então pensa nisso aqui também"},
    { text: "Quem eu quero é você"},
    { text: "Quero namorar com você"},
    ...
    { text: "Se eu pudesse voltar no passado... Pra dentro daquele ônibus de novo... ainda sim te escolheria, escolheria a melhor decisão da minha vida"},
    ...
    { text: "Você é quem eu amo perdidamente, a pessoa que meu coração escolheu, por quem eu aguardo até hoje"},
    ...
    { text: "Mas eu te amo muito, amo tanto que meu peito grita por você todos os dias"},
    ...
    { text: "Que um dia vai olhar pra mim no altar e dizer 'sim' sem nem hesitar"},
    { text: "Eu te amo, com todo meu coração eu te amo"},
    { text: "E quero passar o resto da minha vida te amando e sendo amado por você"},
    { text: "Quero construir uma vida contigo, quero envelhecer contigo, quero viver cada momento da minha vida ao seu lado"},
    { text: "Eu sei que não sou perfeito, sei que vacilo muitas vezes, sei que erro muito e continuo errando em muitas coisas"},
    ...
    { text: "Não posso te obrigar a nada, não posso fazer você me querer..."},
    { text: "Não posso te obrigar a sentir o mesmo que eu sinto, nem obrigar a me querer"},
    { text: "Então mesmo que doa, mesmo que meu coração se quebre em mil pedaços... eu aceito sua decisão"},
    { text: "Não vou mais te procurar, não vou mais te mandar mensagem, não vou mais correr atrás de você"},
    ...
    { text: "Só quero que seja feliz, mesmo que não seja comigo"},,
    { text: "Quero que encontre alguém que te faça feliz, que te ame do jeito que você merece ser amada"},
